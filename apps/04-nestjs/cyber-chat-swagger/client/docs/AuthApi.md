...
|------------- | ------------- | -------------|
| [**authControllerLogin**](AuthApi.md#authcontrollerlogin) | **POST** /auth/login | Log in with username and password |
| [**authControllerMe**](AuthApi.md#authcontrollerme) | **GET** /auth/me | Get the currently authenticated user |
...
> UserResponseDto authControllerRegister(createUserDto)
