...
const HomePage = () => {
  return (
    <section className="relative flex min-h-[85vh] items-end overflow-hidden bg-dusk">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t from-dusk via-dusk/50 to-transparent" />
      <div className="relative z-10 flex w-full max-w-[640px] flex-col items-start gap-3 px-6 py-12 text-white md:px-16 md:py-16">
