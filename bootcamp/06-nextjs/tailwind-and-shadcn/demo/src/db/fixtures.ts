...
const hot: Category = { id: 1, name: 'hot', color: '#CC4444' };
const cold: Category = { id: 2, name: 'cold', color: '#4455CC' };
const sweets: Category = { id: 3, name: 'sweets', color: '#cccc99' };
...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    imageUrl: '/images/menu/classic-lemonade.jpg',
    priceCents: 390,
    category: cold,
  },
  {
    ...
    imageUrl: '/images/menu/pink-grapefruit-lemonade.jpg',
    priceCents: 420,
    category: cold,
  },
  {
